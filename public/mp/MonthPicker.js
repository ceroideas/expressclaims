...
(function ($, window, document, Date) {
    ...
    $.MonthPicker = {
        ...
        i18n: {
            ...
            next12Years: 'Salto in avanti di 12 anni',
            prev12Years: 'Salta indietro di 12 anni',
            nextLabel: 'Precedente',
            prevLabel: 'Successivo',
            buttonText: 'Scelta mese aperto',
            jumpYears: 'Salta anni',
            backTo: 'Torna a',
            months: ['Gen.', 'Feb.', 'Mar.', 'Apr.', 'Mag.', 'Giug.', 'Lug.', 'Ago.', 'Set.', 'Ott.', 'Nov.', 'Dic.']
        }
    };
