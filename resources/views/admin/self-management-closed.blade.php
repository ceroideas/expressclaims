...
<div class="row">
	<div class="col-sm-12">
		<div class="panel">
			<div class="panel-heading">Autoperizia chiusi</div>
			<div class="panel-body">
				<form action="{{url('admin/self-management-closed')}}" method="GET">
                    <div class="row">
						...
						@php
							$claims = App\User::where(function($q){
					            $q->whereExists(function($q){
					                ...
					                ->whereRaw('self_managements.status = 0')
					        ...
					        })->leftJoin('self_managements','users.id','self_managements.user_id')
                            ->select('users.id','users.name','users.created_at','self_managements.created_at')
                            ->orderBy('self_managements.updated_at','desc')
                            ->paginate(10);
	                    ...
	                    @foreach ($claims as $u)
                        	<tr>
                        		...
                        		<td>
                        			...
                        			{{-- <a target="_blank" data-toggle="modal" href="#get-link{{$u->id}}" class="btn btn-warning btn-xs">Rimanda sms</a> --}}
